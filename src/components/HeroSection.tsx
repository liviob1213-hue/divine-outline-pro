    ...
    <section className="relative overflow-hidden rounded-2xl mb-8">
      ...
      <div className="relative z-10 px-6 py-12 md:py-16">
        <motion.div
          ...
          <Link
            to="/criar-esboco"
            className="inline-flex items-center gap-2 bg-gradient-gold font-body font-bold text-sm px-6 py-3.5 rounded-xl shadow-gold hover:scale-105 transition-transform text-white">
