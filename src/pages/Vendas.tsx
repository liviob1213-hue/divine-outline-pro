...
import {
  ...
  Users, Crown, ChevronDown, Play } from
"lucide-react";
...
{ name: "Pr. João Paulo", city: "Curitiba, PR", text: "Testei o mBiblia, o YouVersion e vários outros. Nenhum chega perto do PregAI. É feito pensando no pastor, não só no leitor casual.", stars: 5, avatar: "JP" },
...
const faqs = [
{ q: "Posso acessar de qualquer dispositivo?", a: "Sim! O PregAI funciona em celular, tablet e computador — basta abrir no navegador." },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 pt-12 pb-16 md:pt-20 md:pb-24 bg-[#121216]">
          <div className="text-center">
            ...
            <motion.p
              className="text-lg md:text-xl text-muted-foreground font-body max-w-2xl mx-auto mb-8 leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 px-4 bg-card/50">
        <div className="max-w-4xl mx-auto text-center bg-[#190c31]">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-8">
            <p className="text-lg font-display font-bold text-foreground">
              O PregAI resolve <span className="text-gradient-gold">todos esses problemas</span> numa única ferramenta.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-display text-2xl md:text-4xl font-bold text-center mb-3">
            PregAI vs <span className="text-gradient-gold">mBíblia</span>
          </h2>
          <p className="text-center text-muted-foreground font-body mb-8">Veja por que pastores estão migrando</p>

          <div className="rounded-2xl border border-border overflow-hidden">
            <div className="grid grid-cols-3 bg-primary/10 font-body font-bold text-xs uppercase tracking-wider">
              <div className="p-3 text-muted-foreground">Recurso</div>
              <div className="p-3 text-center text-foreground">PregAI</div>
              <div className="p-3 text-center text-muted-foreground">mBíblia</div>
            </div>
            {comparison.map((row, i) =>
            <div key={i} className={`grid grid-cols-3 text-sm font-body ${i % 2 === 0 ? "bg-card" : "bg-card/50"} border-t border-border`}>
      ...
      <section className="py-16 px-4 bg-card/30">
        <div className="max-w-5xl mx-auto">
          <h2 className="font-display text-2xl md:text-4xl font-bold text-center mb-3">
            O que Pastores Dizem <span className="text-gradient-gold">Sobre o PregAI</span>
          </h2>
          <p className="text-center text-muted-foreground font-body mb-10">Depoimentos reais de quem usa todos os dias</p>
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground font-body text-lg mb-8 max-w-xl mx-auto">
            Junte-se a mais de 2.400 pastores que já transformaram sua preparação ministerial com o PregAI.
          </p>
          <Button
            onClick={scrollToPrice}
            size="lg"
